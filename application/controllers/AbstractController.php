...
class AbastractController{
    ...
    */
    public static function definePagination($max_num_of_items_for_page, $number_of_items, $url_to_html_view, $current_page, $order, $dir){
        ...
        AbastractController::addPageButtons($url_to_html_view, $num_pages_needed, $current_page, $order, $dir);
        AbastractController::addPreviousPageButton($current_page, $url_to_html_view, $order, $dir);
        AbastractController::addNextPageButton($current_page, $url_to_html_view, $num_pages_needed, $order, $dir);
    }

    public static function addPageButtons($url_to_html_view, $num_pages, $current_page, $order, $dir){
        $page_buttons = "";
        for($i=1;$i<=$num_pages;$i++) {
            $url_to_page = $url_to_html_view . "?page=" . $i . "&order=" . $order . "&dir=" . $dir; 
    ...
    public static function addPreviousPageButton($current_page, $url_to_html_view, $order, $dir){
        if($current_page == 1) {
            ...
            $url_to_previous_page = $url_to_html_view  . "?page=" . ($current_page - 1) . "&order=" . $order . "&dir=" . $dir;  
    ...
    public static function addNextPageButton($current_page, $url_to_html_view, $last_page_num, $order, $dir){
        if($current_page == $last_page_num) {
            ...
            $url_to_next_page = $url_to_html_view  . "?page=" . ($current_page + 1) . "&order=" . $order . "&dir=" . $dir;  
            $next_page_button = '<li>
